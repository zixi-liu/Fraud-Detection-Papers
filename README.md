...
- 数据预处理，特征选择，特征降维
- [[综述]风控对抗中的常规特征及处置选择](https://zhuanlan.zhihu.com/p/62525083)
...
- 交叉组合FM/分箱 Binning/Count Encoding/Target Encoding/Odds Ratio/相关系数/WOE
  ...
  - [CTR和推荐系统中常用的Feature Hashing](https://www.zhihu.com/question/264165760)
...
- [[Graph Laplacian] Eigenvalues of the Laplacian and Their Relationship To The Connectedness of a Graph](https://math.uchicago.edu/~may/REU2013/REUPapers/Marsden.pdf)
- [EigenSpokes: Surprising Patterns and Scalable Community Chipping in Large Graphs](https://faculty.cc.gatech.edu/~badityap/papers/eigenspokes-pakdd10.pdf)
